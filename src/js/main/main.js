...
const our_services_box = document.querySelectorAll(".our-services_box");
const our_services_title = document.getElementById("our_services_title");
const our_services_p = document.querySelectorAll(".our-services_box p");
const our_serviceshsubTitle = document.querySelectorAll(".our-services_box h4");
const our_services_icon = document.querySelectorAll(".our-services_box i");
const cryptopedia_text = document.getElementById("cryptopedia_text");
const pathfinder_24hAvgPrice = document.getElementById("24hAvgPrice");
const pathfinder_24hTransactionsCount = document.getElementById("24hTransactionsCount");
const pathfinder_market_cap = document.getElementById("market_cap");
const services_title = document.querySelectorAll(".service_title");
const service = document.querySelectorAll(".service");
const pathfinder_box = document.querySelectorAll(".service_container-box, .inspector_container-box");
const pathfinder_p = document.querySelectorAll(".service_container-box-body p, .inspector_container-box-body p");
const pathfinder_h4 = document.querySelectorAll(".service_container-box-title-sub h4");
const final_balance_address = document.getElementById("final-balance-address");
const n_transactions_address = document.getElementById("n-transactions-address");
const bitcoin_in_address = document.getElementById("bitcoin-in-address");
const bitcoin_out_address = document.getElementById("bitcoin-out-address");
const inspector_input = document.querySelector(".inspector input");
const inspector_label = document.querySelector(".inspector label");
const footer = document.getElementById("footer");
const lang_icon = document.getElementById("lang_icon");
const lang_icon_mobile = document.getElementById("lang_icon_mobile");
const random_addresses = ["bc1q78x7yazvpvdt430jkyla9px0utfwk3r89n5c0k", "381DJouqNj1q7NWSVZaVNhAhmvoJjDF8Po", "bc1qgefpcyzlxstn7yq0apf70f934z45x3lqgkk9s5", "1763CAcXuUdteeSBYTHcTeWGuP2jw5UMTL", "bc1qdsvy53qyl0shxctu2wvq74tq5e70hrur88l8pc", "13UVCajHLSc1bZsM8chCqCeSKh41DuYbzh", "bc1qm34lsc65zpw79lxes69zkqmk6ee3ewf0j77s3h"];
const impact_title = document.getElementById("impact_title");
const impact_sub_title = document.getElementById("impact_sub-title");
const impact_text = document.getElementById("impact_text");
const impact_cta = document.getElementById("impact_cta");
const pathfinder_text = document.getElementById("pathfinder_text");
const inspector_text = document.getElementById("inspector_text");
const pathfinder_info_1 = document.getElementById("pathfinder_info_1");
const pathfinder_info_2 = document.getElementById("pathfinder_info_2");
const pathfinder_info_3 = document.getElementById("pathfinder_info_3");
const inspector_info_1 = document.getElementById("inspector_info_1");
const inspector_info_2 = document.getElementById("inspector_info_2");
const inspector_info_3 = document.getElementById("inspector_info_3");
const inspector_info_4 = document.getElementById("inspector_info_4");
const cryptopedia_box = document.querySelectorAll(".cryptopedia_container-box");
const cryptopedia_title = document.querySelectorAll(".cryptopedia_container-box h4");
const cryptopedia_description = document.querySelectorAll(".cryptopedia_container-box p");
const cryptopedia_link = document.querySelectorAll(".cryptopedia_container-box a");
const ripple_img = document.getElementById("ripple-img");
const eos_img = document.getElementById("eos-img");
const bitcoin_text = document.getElementById("bitcoin-text");
const ethereum_text = document.getElementById("ethereum-text");
const tether_text = document.getElementById("tether-text");
const cardano_text = document.getElementById("cardano-text");
const ripple_text = document.getElementById("ripple-text");
const eos_text = document.getElementById("eos-text");
...
function itLang() {
    ...
    cryptopedia_link.forEach(element => {
...
function lightMode() {
    ...
    our_services_p.forEach(element => {
        element.style.color = "#343352";
    });

    our_serviceshsubTitle.forEach(element => {
        element.style.color = "#343352";
    });

    pathfinder_box.forEach(element => {
        element.style.backgroundColor = "#FFFFFF";
        element.style.boxShadow = "rgb(196 196 196 / 24%) 0px 0px 24px";
    });

    services_title.forEach(element => {
        element.style.color = "#343352";
        element.style.backgroundColor = "#FFFFFF";
    });

    our_services_icon.forEach(element => {
        element.style.color = "#636A6F";
    });

    our_services_box.forEach(element => {
        element.style.backgroundColor = "#FFFFFF";
    });

    pathfinder_h4.forEach(element => {
        element.style.color = "#343352";
    })
    ...
    pathfinder_p.forEach(element => {
        element.style.color = "black";
    });

    cryptopedia_box.forEach(element => {
        element.style.backgroundColor = "#ffffff";
        element.style.boxShadow = "0 0 24px rgb(196 196 196 / 24%)";
    });

    cryptopedia_title.forEach(element => {
        element.style.color = "#343352";
    });
    ...
    cryptopedia_description.forEach(element => {
